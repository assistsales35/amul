...
export default function Dashboard() {
  ...
  const handleTriggerChatbot = (context: any) => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case "executive-summary":
        return <ExecutiveSummaryTab timeRange={timeRange} onTriggerChatbot={handleTriggerChatbot} />;
      case "demand-supply":
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* AI Assistant Popup - Fixed to bottom right */}
      {showChatbot && (
        <IntelligentChatbot
