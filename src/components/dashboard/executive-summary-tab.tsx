      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 mb-8 shadow-md">
          <div className="flex items-start">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#d0e2ff]">₹9.6 Lakhs at Risk Today</h2>
              <p className="text-[#d0e2ff] mt-1">Immediate action required: Inventory sync delays causing significant revenue loss and customer dissatisfaction</p>
        </div>
      </div>
        </div>
