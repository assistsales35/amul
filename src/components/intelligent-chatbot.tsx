...
import { TrendingUp, AlertTriangle, Factory, Truck, Search, Send, Bot, User, BarChart3, PieChart, Activity, Target, X } from "lucide-react";
...
export default function IntelligentChatbot({ isVisible, onClose }: IntelligentChatbotProps) {
